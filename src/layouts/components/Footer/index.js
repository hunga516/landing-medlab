        ...
        <div className="w-full p-4 sm:px-8 sm:py-4 md:px-16 md:py-0 bg-blue-100 rounded-tr-lg rounded-tl-lg pb-24">
            <div className="flex items-center justify-between gap-2 pt-8 pb-4  border-b-[0.5px] border-sky-400">
                <div className="flex items-center gap-2">
                    ...
                    <p className="hidden md:block bg-gradient-to-br from-sky-900 to-sky-500 text-transparent bg-clip-text text-sm font-semibold font-sans">Medlab
                        Vĩnh Viễn</p>
                </div>
                <div className="flex items-center gap-2">
                    <div
            ...
            <div className="grid grid-cols-4 gap-4 gap-y-8 mt-4">
                ...
                <div className="grid-item-3">
                    ...
                    <p className="text-[10px] sm:text-sm text-sky-600 mt-2">Khách hàng tra cứu</p>
                ...
                <div className="grid-item-4 col-span-2">
                    ...
                    <p className="text-sky-600 text-[10px] sm:text-sm mt-2">Trung Tâm Xét Nghiệm Y Khoa Medlab, <p
                        className="">250 Đ. Vĩnh Viễn, Phường 4, Quận 10, Hồ Chí Minh, Việt Nam</p>
                    </p>
                </div>
                <div className="grid-item-5">
                    <h2 className="text-[10px] sm:text-sm text-sky-600 font-bold">LIÊN KẾT XÃ HỘI</h2>
                    <div className="flex mt-2.5 items-center gap-3">
                        <img src={images.facebook} alt="facebook logo" className="w-6 h-6" />
                        <img src={images.zalo} alt="zalo logo" className="w-6 h-6" />
                        <img src={images.insta} alt="insta logo" className="w-6 h-6" />
                    </div>
                </div>
                <div className="grid-item-6">
                    <h2 className="text-[10px] sm:text-sm text-sky-600 font-bold">PHƯƠNG THỨC THANH TOÁN</h2>
                    <div className="flex mt-2 items-center gap-3">
                        <img src={images.momo} alt="momo logo" className="w-6 h-6" />
                        <img src={images.vietqr} alt="vietqr logo" className=" h-6" />
                        <img src={images.tienmat} alt="tienmat logo" className="h-8" />
                    </div>
                </div>
            </div>
