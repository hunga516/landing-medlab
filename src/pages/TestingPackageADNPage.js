                ...
                <div onClick={() => toggleArcordion('arcordion1')} className="bg-blue-300/30 rounded-lg p-6">
                    ...
                    <div
                        ...
                        <ul className="list-none flex flex-col gap-2 text-xl">
                            ...
                            <li className="flex items-center gap-3">
                                <FaCheckCircle className="text-blue-600 flex-shrink-0" />
                                Phụ nữ mang thai hoặc cho con bú: Cần dưỡng chất để phát triển sức khỏe của cả mẹ và bé.                            </li>
                            <li className="flex items-center gap-3">
                                <FaCheckCircle className="text-blue-600 flex-shrink-0" />
                                Vận động viên và người tập thể thao: Cần bổ sung dưỡng chất để duy trì sức bền và phục hồi.                            </li>
                        </ul>
                    </div>
                </div>
