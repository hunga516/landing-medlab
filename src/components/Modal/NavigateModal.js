            ...
            <div className="absolute flex flex-col justify-between top-0 bottom-0 left-0 w-52 md:w-80 bg-white py-4 md:py-8 px-4">
                <div>
                    ...
                    <div className="flex flex-col gap-1 items-start">
                        <button
                            className="w-full flex items-center gap-2 text-xs font-medium bg-sky-600 hover:bg-sky-700 rounded-lg leading-4 pl-2 py-1 pr-1.5 text-white">
                        ...
                        <button
                            className="w-full bg-sky-800 text-xs flex items-center gap-2 px-2 py-2.5 tracking-wide font-medium text-white/85 rounded-lg">
                            <FaPhone className="" />
                            0909 636293
                        </button>
                    </div>
